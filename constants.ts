...
export const EMPLOYEES: Employee[] = [
  ...
  { id: 'emp3', name: 'Empleado 3', role: 'Diseñador UI/UX', email: 'emp3@empresa.com', isAdmin: false },
...
export const QUESTIONS: Question[] = [
  { id: 1, text: '¿Muestra iniciativa para resolver problemas complejos?', category: 'Técnico', section: 'peer', type: 'scale' },
  { id: 2, text: '¿Se comunica de manera clara y efectiva con el equipo?', category: 'Comunicación', section: 'peer', type: 'scale' },
  { id: 3, text: '¿Cumple con las entregas en los plazos acordados?', category: 'Comportamiento', section: 'peer', type: 'scale' },
  { id: 4, text: '¿Colabora activamente ayudando a sus compañeros?', category: 'Comportamiento', section: 'peer', type: 'scale' },
  { id: 5, text: '¿Muestra apertura ante críticas constructivas?', category: 'Comunicación', section: 'peer', type: 'scale' },
  { id: 6, text: '¿Inspira confianza y motiva a los demás?', category: 'Liderazgo', section: 'peer', type: 'scale' },
  { id: 7, text: '¿Demuestra dominio de las herramientas y tecnologías requeridas?', category: 'Técnico', section: 'peer', type: 'scale' },
  { id: 8, text: '¿Mantiene una actitud profesional bajo presión?', category: 'Comportamiento', section: 'peer', type: 'scale' },
